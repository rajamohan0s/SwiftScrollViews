...
//        
//        self.notification.addObserver(forName:  UIResponder.keyboardDidChangeFrameNotification, object: nil, queue: nil) { (notification) in
...
//        if isShow{
//            
//            print("ideal:",self.contentInset.bottom)
...
//                
//                print("Scrolling...")
//                let heightValue = nextComponent.textField == nil ? fontSize+SwiftScrollViews.config.textComponentSpaceFromKeyboard : nextComponent.frame.height+fontSize+(SwiftScrollViews.config.textComponentSpaceFromKeyboard*8)
//                
//                //                self.setContentOffset(CGPoint(x: self.contentOffset.x, y: self.contentOffset.y), animated: true)
//            }
//            
//        }else{
//            
